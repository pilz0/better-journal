package foo.pilz.freaklog.ui.main.navigation
...
fun topLevelRoutes(
    ...
    if (showInventory) {
        TopLevelRoute("Inventory", InventoryTopLevelRoute, Icons.Filled.Inventory2, Icons.Outlined.Inventory2)
    } else null,
